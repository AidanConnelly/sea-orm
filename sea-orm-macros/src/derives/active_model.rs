...
use syn::{
    punctuated::IntoIter, Attribute, Data, DataStruct, Expr, Field, Fields, LitStr, Meta, MetaList,
    Path, Type,
};
...
pub fn expand_derive_active_model(
    ...
    let derive_active_model = derive_active_model(&ident, all_fields.clone(), attrs)?;
...
fn derive_active_model(
    ...
    Ok(quote!(
        fn qwerty(){println!("honk: {}", #derive_deserialize_serialize);}
